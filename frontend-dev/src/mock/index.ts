...
function defaults(): AppData {
  ...
  return {
    ...
    agents: [
      ...
      { id: 'openclaw', name: 'OpenClaw', product: 'OpenClaw Local', icon: 'openclaw', status: 'online', accent: '#D64045', models: ['local-llama-3.3-70b', 'qwen3-coder-30b'], price: '¥0.03', unit: '/千token', tags: ['本地算力', '私有数据'], desc: '完全本地运行的长时任务代理，数据不出本机，适合敏感场景。' },
      { id: 'hermes', name: 'Hermes', product: 'Hermes Reasoning', icon: 'hermes', status: 'standby', accent: '#2d6376', models: ['hermes-4-405b', 'deepseek-r1'], price: '¥0.05', unit: '/千token', tags: ['深度推理', '分析'], desc: '高强度推理与结构化分析代理，数学、逻辑、研究场景首选。' },
    ],
    ...
    marketplace: [
      ...
      { id: 'm3', cat: 'reason', name: 'Hermes 深度推理', vendor: '王启明', vendorGithub: 'wang-qiming', icon: 'hermes', accent: '#2d6376', online: true, rating: 4.9, orders: 741, price: '¥0.05/千token', priceNum: 0.05, tags: ['推理', '分析'], models: ['hermes-4-405b', 'deepseek-r1'], desc: '数学、逻辑与结构化研究任务的高强度推理代理，输出带完整推导过程。', sla: '平均响应 3min · 成功率 97.4%' },
      { id: 'm4', cat: 'ops', name: 'OpenClaw 本地算力', vendor: '陈默', vendorGithub: 'chenmo-dev', icon: 'openclaw', accent: '#D64045', online: true, rating: 4.7, orders: 388, price: '¥0.03/千token', priceNum: 0.03, tags: ['本地算力', '隐私'], models: ['local-llama-3.3-70b', 'qwen3-coder-30b'], desc: '数据不出本机的工作代理，适合处理敏感代码与内部文档，按真实算力成本计价。', sla: '平均响应 2min · 成功率 96.1%' },
