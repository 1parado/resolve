  ...
  function defaults() {
    ...
    return {
      ...
      agents: [
        ...
        { id: 'openclaw', name: 'OpenClaw', product: 'OpenClaw Local', icon: 'openclaw', status: 'online', accent: '#7C3AED',
          models: ['local-llama-3.3-70b', 'qwen3-coder-30b'], price: '¥0.03', unit: '/千token', tags: ['本地算力', '私有数据'], desc: '完全本地运行的长时任务代理，数据不出本机，适合敏感场景。' },
        { id: 'hermes', name: 'Hermes', product: 'Hermes Reasoning', icon: 'hermes', status: 'standby', accent: '#E8590C',
      ...
      marketplace: [
        ...
        { id: 'm3', cat: 'reason', name: 'Hermes 深度推理', vendor: '王启明', vendorGithub: 'wang-qiming', icon: 'hermes', accent: '#E8590C', online: true, rating: 4.9, orders: 741, price: '¥0.05/千token', priceNum: 0.05,
          tags: ['推理', '分析'], models: ['hermes-4-405b', 'deepseek-r1'], desc: '数学、逻辑与结构化研究任务的高强度推理代理，输出带完整推导过程。', sla: '平均响应 3min · 成功率 97.4%' },
        { id: 'm4', cat: 'ops', name: 'OpenClaw 本地算力', vendor: '陈默', vendorGithub: 'chenmo-dev', icon: 'openclaw', accent: '#7C3AED', online: true, rating: 4.7, orders: 388, price: '¥0.03/千token', priceNum: 0.03,
